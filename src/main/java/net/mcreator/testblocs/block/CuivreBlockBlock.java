...
public class CuivreBlockBlock extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:cuivre_block")
	public static final Block block = null;
	public CuivreBlockBlock(TestBlocsModElements instance) {
		super(instance, 116);
	}
