...
public class RubyOreBlock extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(TestBlocsModElements instance) {
		super(instance, 26);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("test_blocs_:ruby_ore_match"), () -> CustomRuleTest.codec);
