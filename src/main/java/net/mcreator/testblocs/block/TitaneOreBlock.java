...
public class TitaneOreBlock extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:titane_ore")
	public static final Block block = null;
	public TitaneOreBlock(TestBlocsModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("test_blocs_:titane_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("test_blocs_:titane_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
