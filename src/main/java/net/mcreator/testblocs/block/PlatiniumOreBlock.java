...
public class PlatiniumOreBlock extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:platinium_ore")
	public static final Block block = null;
	public PlatiniumOreBlock(TestBlocsModElements instance) {
		super(instance, 80);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("test_blocs_:platinium_ore_match"), () -> CustomRuleTest.codec);
