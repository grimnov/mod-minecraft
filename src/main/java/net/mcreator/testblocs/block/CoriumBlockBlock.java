...
public class CoriumBlockBlock extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:corium_block")
	public static final Block block = null;
	public CoriumBlockBlock(TestBlocsModElements instance) {
		super(instance, 134);
	}
