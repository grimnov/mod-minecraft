...
public class RubiAxeItem extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:rubi_axe")
	public static final Item block = null;
	public RubiAxeItem(TestBlocsModElements instance) {
		super(instance, 32);
	}
