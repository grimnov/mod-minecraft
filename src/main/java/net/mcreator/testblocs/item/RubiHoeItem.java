...
public class RubiHoeItem extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:rubi_hoe")
	public static final Item block = null;
	public RubiHoeItem(TestBlocsModElements instance) {
		super(instance, 35);
	}
