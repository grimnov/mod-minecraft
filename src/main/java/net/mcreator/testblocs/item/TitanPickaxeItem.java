...
public class TitanPickaxeItem extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:titan_pickaxe")
	public static final Item block = null;
	public TitanPickaxeItem(TestBlocsModElements instance) {
		super(instance, 13);
	}
