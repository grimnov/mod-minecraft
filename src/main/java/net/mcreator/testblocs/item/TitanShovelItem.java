...
public class TitanShovelItem extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:titan_shovel")
	public static final Item block = null;
	public TitanShovelItem(TestBlocsModElements instance) {
		super(instance, 16);
	}
