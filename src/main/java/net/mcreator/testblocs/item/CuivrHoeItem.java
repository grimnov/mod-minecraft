...
public class CuivrHoeItem extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:cuivr_hoe")
	public static final Item block = null;
	public CuivrHoeItem(TestBlocsModElements instance) {
		super(instance, 126);
	}
