...
public class CuivrAxeItem extends TestBlocsModElements.ModElement {
	@ObjectHolder("test_blocs_:cuivr_axe")
	public static final Item block = null;
	public CuivrAxeItem(TestBlocsModElements instance) {
		super(instance, 123);
	}
